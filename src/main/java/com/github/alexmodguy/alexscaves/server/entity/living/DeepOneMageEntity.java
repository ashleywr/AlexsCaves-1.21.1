...
public class DeepOneMageEntity extends DeepOneBaseEntity {
    ...
    public static final ResourceKey<LootTable> BARTER_LOOT = ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID, "gameplay/deep_one_mage_barter"));
