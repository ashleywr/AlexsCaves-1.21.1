...
public class ExtinctionSpearEntity extends AbstractArrow {
    ...
    public ExtinctionSpearEntity(EntityType entityType, Level level) {
        ...
        this.spearItem = new ItemStack(ACItemRegistry.EXTINCTION_SPEAR.get());
    }
    ...
    protected ItemStack getDefaultPickupItem() {
        if (spearItem == null || spearItem.isEmpty()) {
            return new ItemStack(ACItemRegistry.EXTINCTION_SPEAR.get());
        }
        return spearItem;
    }
    ...
    protected void onHitEntity(EntityHitResult hitResult) {
        ...
        if (entity.hurt(damagesource, f)) {
            ...
            if(entity1 != null){
                ...
                dinosaurSpirit.setEnchantmentLevel(0);
