...
public class CommonProxy {
    ...
    public void setModEventBus(IEventBus bus) {
    ...
    public void initPathfinding() {
        ...
        PathfindingConstants.pathfindingThreads = Math.max(PathfindingConstants.pathfindingThreads, ACServerConfig.INSTANCE.pathfindingThreads.get());
    }
