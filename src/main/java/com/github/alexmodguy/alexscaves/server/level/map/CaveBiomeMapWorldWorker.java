...
public class CaveBiomeMapWorldWorker implements WorldWorkerManager.IWorker {
    ...
    public void onWorkComplete(@Nullable BlockPos biomeCorner) {
        if(!complete){
            CompoundTag tag = map.getOrDefault(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.EMPTY).copyTag();
            if (biomeCorner != null) {
            ...
            tag.remove("MapUUID");
            map.set(net.minecraft.core.component.DataComponents.CUSTOM_DATA, net.minecraft.world.item.component.CustomData.of(tag));
